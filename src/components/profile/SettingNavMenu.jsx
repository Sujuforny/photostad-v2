...
export default function SettingNavMenu() {
  ...
  return (
    ...
    <aside className="sidebar max-sm:hidden justify-start w-[318px] h-screen bg-white dark:bg-slate-800 rounded-main  ">
                ...
                <div className="menu-item-collapse">
                  <div className="min-h-0">
                    <Link href={"/profile/setting/generalsetting"}>
                      <label className="menu-item ml-6">General setting</label>
                    </Link>
